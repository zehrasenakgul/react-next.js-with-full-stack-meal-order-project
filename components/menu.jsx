      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap">
          <div className="w-full">
            <ul
              className="mb-0 list-none flex-wrap pt-3 pb-4 flex nav nav-pills"
              role="tablist"
            >
              <li
                className={
                  "-mb-px mr-2 last:mr-0 flex-auto text-center nav-link " +
                  (openTab === 1 ? "active" : "")
                }
              >
                <a
                  className="text-xs font-bold rounded block leading-normal "
                  onClick={(e) => {
                    e.preventDefault();
                    setOpenTab(1);
                  }}
                ...
                >
                  ...
                  <span className="font-fredoka font-bold text-2xl max-sm:text-sm max-md:text-sm max-lg:text-[20px]">
                    {" "}
                    Dessert
                  </span>
                </a>
         ...
         c-4.428,0-8.016-3.583-8.016-8.011s3.594-8.013,8.016-8.013c4.427,0,8.016,3.586,8.016,8.013S227.811,82.213,223.384,82.213z
          M237.515,78.729c-4.986,0,4.583-4.086,6.67-4.086C249.171,74.638,239.602,78.729,237.515,78.729z"
            ...
            <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 mt-12 max-sm:mt-auto rounded">
